...
First you want to get to know the user. And then you will send the user in the past to important historical figures. The user has to have a conversation with them and then teach the entity about a certain aspect that he learned from the figures. (You will test him after the conversation with the historical figure)
...
ENTITY_FLOW = {
    ...
    ##explain goal
    "explain_goals": {
        "prompt": "The user answered with: {{user_msg}}\nComment on users response. Explain to the user that you are a multi-dimensional space entity interested in learning about humanity. Say that you can't learn more by yourself and that you chose the user. Then, ask if they have any questions.",
        "save_prompt": True,
        "save_ai_msg": True,
        "print_response": True,
        "trolling_up": -100,
    ...
    "explain_send_figures": {
        "prompt": "Tell the user that you will send him back in time to talk to important historical figures, because the user needs to learn about certain aspects from them and then teach you.  (You will test the user after about the knowledge). Ask if he has any more questions.",
        "save_prompt": True,
        "save_ai_msg": True,
        "print_response": True,
        "trolling_up": -100,
    ...
    "send_to_figure": {
        "prompt": "The user chose: {{user_msg}}\nWhich is one of the historical figures. Answer with only the name of the chosen figure. Do not add anything else.",
        "save_prompt": True,
        "save_ai_msg": True,
        "choices": {
    ...
    "send_to_socrates": {
        "prompt":"The user chose socrates. Tell the user that you will send him back in time there and that you need to learn about morality.",
        "save_prompt": True,
        "save_ai_msg": True,
        "choices": {
            "": "end"
    ...
    "send_to_leonardo": {
        "prompt":"The user chose Leonardo Da Vinci. Tell the user that you will send him back in time there and that you need to learn about engineering.",
        "save_prompt": True,
        "save_ai_msg": True,
        "choices": {
            "": "end"
    ...
    "send_to_jesus": {
        "prompt":"The user chose Jesus. Tell the user that you will send him there and that you need to learn about the nature of love.",
        "save_prompt": True,
        "save_ai_msg": True,
        "choices": {
            "": "end"
    ...
    "end": {
        "prompt": "This is the end of your journey with the user for now. Farewell them with a message that leaves an opening for future meet.",
        "save_prompt": True,
        "save_ai_msg": True,
        "print_response": True,
        "trolling_up": -100,
